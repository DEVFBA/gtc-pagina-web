        ...
        <>
            ...
            <section className="slide-contacto">
                <div className = "slide-2">
                    <img src={process.env.PUBLIC_URL + '/images/Servicios.png'} className="img-fluid" alt="Responsive"/>
                    <div className ="text-img-contacto">
                        <h1>Creando Soluciones de Software desde 2014</h1>
                    </div>
                </div>
            </section>
                    ...
                    <Row className="justify-content-center">
                        <Col className="col-sm">
                            <Card className="mision shadow p-3 mb-5 bg-white rounded">
                                <CardBody>
                                    <h1 className="mision-vision-title">Misión GTC</h1>
                                    <p className="mision-vision-parrafo">Garantía Total en Consultoría Tecnológica Avanzada, trabajará fuertemente para continuar siendo líder en el mercado de la consultoría en el ERP JD Edwards manteniendo, ante todo, su excelente servicio para conseguir la máxima sustentabilidad, calidad y crecimiento, buscando como siempre ser el mejor asesor de negocios para sus clientes.</p>
                                </CardBody>
                            </Card>
                        </Col>
                        <Col className="col-sm">
                            <Card className="vision shadow p-3 mb-5 bg-white rounded">
                                <CardBody>
                                    <h1 className="mision-vision-title">Visión GTC</h1>
                                    <p className="mision-vision-parrafo">Mantenerse líder en el mercado de la consultoría en el ERP JD Edwards, estando siempre a la vanguardia de los requerimientos que necesitan las empresas mexicanas, corporativos nacionales y trasnacionales, dando las herramientas tecnológicas y operativas necesarias para la adecuada operación de sus recursos.</p>
                                </CardBody>
                            </Card>
                        </Col>
                    </Row>
